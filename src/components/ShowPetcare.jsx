...
const ShowPetcare = () => {
  ...
  return (
    <div className="container">
      <h2 className="text-center text-success">Available Pet Care-takers</h2>
      <hr />
      <div className="row">
      ...
      <center><Link to={"/custlogin"} className='btn btn-primary'>Sign In / Sign Up To Hire</Link></center>
      
    </div>
  );
};

export default ShowPetcare;
